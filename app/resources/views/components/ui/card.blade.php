...
{{-- On a phone every card runs edge to edge, framed only by a hairline above
     and below: the page gutter and a card's own frame are the same 16px twice
     over, and forms and tables alike need every pixel of width there. --}}
<section {{ $attributes->class('relative overflow-hidden rounded-xl border border-hairline bg-surface elevate max-sm:-mx-4 max-sm:rounded-none max-sm:border-x-0 max-sm:shadow-none') }}
