...
{
    /**
     * Platform-level operators ("root users"). Entirely separate from the
     * tenant `users` table and never reachable through a tenant domain —
     * see MEP.md Section 3.3 (Platform operations).
     */
